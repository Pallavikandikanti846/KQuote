...
namespace passion_project_http5226.Controllers
{
    ...
    public class DramaController : Controller
    {
        ...
        /// </returns>
        /// <example>
        /// PUT: api/Category/UpdateDrama/17
        /// Request Headers: Content-Type: application/json
        /// Request Body: {DramaDto}
        /// ->
        /// Response Code: Drama with id " +id+ " Updated Successfully
        /// </example>
        ...
        /// </returns>
        /// <example>
        /// POST: api/Drama/AddDrama
        /// Request Headers: Content-Type: application/json
        /// Request Body: {DramaDto}
        /// ->
        /// Response Code: 201 Created
        /// Response Headers: Location: api/Drama/FindDrama/{DramaId}
        /// </example>
        ...
        /// </returns>
        /// <example>
        /// DELETE: api/Drama/DeleteDrama/7
        /// ->
